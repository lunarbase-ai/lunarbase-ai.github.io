...
| input_types | a `dict` of `DataType`s | The inputs your component receive. The keys of the dictionary will be interpreted as the input labels and you can check the available data types [here](**!! LINK HERE !!**) |
