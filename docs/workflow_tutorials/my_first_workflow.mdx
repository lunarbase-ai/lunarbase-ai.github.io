...
<!-- To learn how to create workflows using the co-pilot feature instead, visit the [Workflow Co-piloting](copilot.mdx) page. -->
...
<ReactPlayer playing controls url='/simple_workflow.mp4' />
